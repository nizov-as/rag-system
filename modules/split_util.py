...
class Doc:    
    ...
    def copy(self):
        met = dict(self.metadata)
        return Doc(page_content = copy.copy(self.page_content), metadata=met)
        
    @classmethod
    def empty(cls):
        return cls(page_content='', metadata = {'is_empty': True})
...
class BaseDocumentTransformer(ABC):
    ...
    def transform_documents(
        self, documents: Sequence[Doc], **kwargs: Any
    ) -> Sequence[Doc]:
...
class TextSplitter(BaseDocumentTransformer, ABC):
    ...
    def split_documents(self, documents: Iterable[Doc]) -> List[Doc]:
        """Split documents."""
        texts, metadatas = [], []
